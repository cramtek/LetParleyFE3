...
import faqImageDark from 'assets/images/sections/misc/faq-dark.webp';
import faqImage from 'assets/images/sections/misc/faq-light.webp';
...
const FaqItems = () => {
  ...
  return (
    <Box sx={{ mx: 'auto', maxWidth: 600 }}>
      ...
      >
        <Box sx={{ p: 5 }}>
          <Image src={{ light: faqImage, dark: faqImageDark }} sx={{ width: 56 }} />
        </Box>
        <div>
